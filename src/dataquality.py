...
if __name__ == "__main__": 
    ...
    input_file = 'data/test_qa.json'  # Birinci aşamadan gelen dosya
    ...
    print(f"\n{Fore.GREEN}✅ Final premium QA'lar: 'data/final_premium_qa.json'{Fore.RESET}")
    print(f"{Fore.GREEN}✅ Final kalite sonuçları: 'data/final_quality_results.json'{Fore.RESET}")